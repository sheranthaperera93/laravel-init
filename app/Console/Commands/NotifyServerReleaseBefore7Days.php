...
class NotifyServerReleaseBefore7Days extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'serverRelease:sevenDays';
     ...
     * @var string
     */
    protected $description = 'This command will check for servers with end date in a weeks time and send server release notification mail';
    ...
    public function handle()
    {
        $serverRequests = ServerRequest::select(
            ...
            'server_requests.approved_cpu_configuration as cpu_configuration',
            'server_requests.approved_ram_configuration as ram_configuration',
            'server_requests.approved_hdd_configuration as hdd_configuration',
        ...
        foreach ($serverRequests as $serverRequest) {
            ...
            $data = array(
                ...
                'end_message' => "and is about to end in 7 days"
            );
